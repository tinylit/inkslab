...
namespace Insklab.Settings
{
    ...
    public class DefaultSettings
    {
        ...
        public string Convert(PropertyInfo propertyInfo, object value)
        {
            ...
            {
                if (converter.CanConvert(propertyInfo))
                {
                    return ValuePackaging(converter.Convert(propertyInfo, value), propertyInfo.PropertyType);
                }
            }
