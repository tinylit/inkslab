...
namespace System
{
    ...
    public static class EnumExtensions
    {
        ...
        /// <returns></returns>
        public static int ToInt32<TEnum>(this TEnum @enum) where TEnum : struct, Enum
        {
            var type = typeof(TEnum);
        ...
        /// <returns></returns>
        public static long ToInt64<TEnum>(this TEnum @enum) where TEnum : struct, Enum
        {
            var type = typeof(TEnum);
        ...
        /// <exception cref="ArgumentException">参数不是枚举类型。</exception>
        /// <returns></returns>
        public static string ToValueString<TEnum>(this TEnum @enum) where TEnum : struct, Enum
        {
            var type = typeof(TEnum);
